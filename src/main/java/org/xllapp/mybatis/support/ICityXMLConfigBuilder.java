...
import org.xllapp.mybatis.support.ICityConfiguration;

/**
 * 使用自定义的ICityConfiguration类.基于Mybatis3.1.1版本的XMLConfigBuilder类进行修改.
 *
 * @author dylan.chen Mar 23, 2014
 * 
 */
public class ICityXMLConfigBuilder extends BaseBuilder{

	  private boolean parsed;
	  private XPathParser parser;
	  private String environment;

	  public ICityXMLConfigBuilder(InputStream inputStream, String environment, Properties props) {
	    this(new XPathParser(inputStream, true, props, new XMLMapperEntityResolver()), environment, props);
	  }

	  private ICityXMLConfigBuilder(XPathParser parser, String environment, Properties props) {
		
		/* 修改开始 */  
	    super(new ICityConfiguration());
	    /* 修改结束 */
